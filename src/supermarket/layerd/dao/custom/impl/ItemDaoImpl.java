...
public class ItemDaoImpl implements ItemDao {
    ...
    public boolean add(ItemEntity t) throws Exception {
        return CrudUtil.executeUpdate("INSERT INTO Item VALUES(?,?,?,?,?)", t.getId(), t.getDescription(),
                t.getPackSize(), t.getUnitPrice(), t.getQty());
    }
    ...
    public boolean update(ItemEntity t) throws Exception {
        return CrudUtil.executeUpdate(
                ...
                t.getDescription(), t.getPackSize(), t.getUnitPrice(), t.getQty(), t.getId());
    }
